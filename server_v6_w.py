...
def export_chart_html():
    ...
    # Генерируем HTML для одного графика
    html_content = generate_single_chart_html(signal_key, use_real_time)
...
def chart_data_single():
    ...
    chart_data = get_single_chart_data(signal_key, int(time_window), real_time)
